...
local function _1_()
    ...
    do
        ...
        _3_ = { mappings = { i = { ["<left>"] = fb.backspace } } }
    end
    telescope.setup({
        defaults = {
            border = true,
...
return {
    ...
    keys = {
        ...
        { "<leader>pf", _4_, desc = "Find [P]roject [F]ile", mode = { "n" } },
        { "<leader>pw", _5_, desc = "Find [P]roject [W]ord", mode = { "n" } },
        { "<leader>fh", _6_, desc = "[F]ind in file [H]istory", mode = { "n" } },
        { "<leader>fb", _7_, desc = "[F]ind [B]uffer", mode = { "n" } },
        { "<leader>fl", _8_, desc = "[F]ind [L]ine", mode = { "n" } },
        { "<leader>fd", _9_, desc = "[F]ind [D]iagnostic", mode = { "n" } },
        { "<leader>fr", _10_, desc = "[F]ind [R]resume", mode = { "n" } },
        { "<leader>fk", _11_, desc = "[F]ind [K]eymap", mode = { "n" } },
