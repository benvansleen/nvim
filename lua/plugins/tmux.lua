...
keymap_29_auto.set({ "n", "t" }, "<A-k>", _2_, { desc = "Navigate up", noremap = true })
local function _3_()
    local mod_12_auto = require("nfnl.module").autoload("Navigator")
    return mod_12_auto.down()
end
keymap_29_auto.set({ "n", "t" }, "<A-j>", _3_, { desc = "Navigate down", noremap = true })
local function _4_()
    local mod_12_auto = require("nfnl.module").autoload("Navigator")
    return mod_12_auto.left()
end
keymap_29_auto.set({ "n", "t" }, "<A-h>", _4_, { desc = "Navigate left", noremap = true })
local function _5_()
    local mod_12_auto = require("nfnl.module").autoload("Navigator")
    return mod_12_auto.right()
end
return keymap_29_auto.set({ "n", "t" }, "<A-l>", _5_, { desc = "Navigate right", noremap = true })
