...
do
    ...
    _1_ = { { keymap_18_auto.set("n", "<leader><leader>g", _3_, { desc = "Open Neogit", noremap = true }) } }
end
local function _5_(...)
    local keymap_18_auto
    do
    ...
    return {
        {
            keymap_18_auto.set("n", "<leader>gs", _6_, { desc = "[G]it: [S]tage hunk", noremap = true }),
            keymap_18_auto.set("n", "<leader>gR", _7_, { desc = "[G]it: [R]eset hunk", noremap = true }),
            keymap_18_auto.set("n", "<leader>gp", _8_, { desc = "[G]it: [P]review hunk", noremap = true }),
        },
    }
end
return { { _1_, _5_(...) } }
