...
do
    ...
    do
        ...
        keymap_30_auto =
            mod_13_auto.keymap({ "diffview.nvim", after = _4_, for_cat = "general.git", on_require = "diffview" })
    end
end
local keymap_30_auto
do
    ...
    keymap_30_auto =
        mod_13_auto.keymap({ "gitsigns.nvim", after = _5_, event = "DeferredUIEnter", for_cat = "general.git" })
end
local function _6_()
