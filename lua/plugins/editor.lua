...
do
    ...
    do
        ...
        keymap_30_auto =
            mod_12_auto.keymap({ "hbac-nvim", after = _23_, event = "DeferredUIEnter", for_cat = "general" })
    end
end
do
    local keymap_30_auto
    do
        ...
        keymap_30_auto = mod_12_auto.keymap({ "mini.ai", after = _24_, event = "DeferredUIEnter", for_cat = "general" })
    end
end
do
    local keymap_30_auto
    do
        ...
        keymap_30_auto =
            mod_12_auto.keymap({ "mini.indentscope", after = _27_, event = "DeferredUIEnter", for_cat = "general" })
    end
end
do
    local keymap_30_auto
    do
        ...
        keymap_30_auto =
            mod_12_auto.keymap({ "nvim-surround", after = _30_, event = "DeferredUIEnter", for_cat = "general" })
    end
end
local keymap_30_auto
do
