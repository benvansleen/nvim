...
do
    local keymap_20_auto
    do
        keymap_20_auto = require("lzextras").keymap({ "dial.nvim", for_cat = "general.extra", on_require = "dial" })
    end
    local function _4_()
    ...
    _3_ = {
        {
            keymap_20_auto.set("n", "<C-a>", _4_, { desc = "Increment", noremap = true }),
            keymap_20_auto.set("n", "<C-x>", _5_, { desc = "Decrement", noremap = true }),
            keymap_20_auto.set("n", "g<C-a>", _6_, { desc = "Increment", noremap = true }),
            keymap_20_auto.set("n", "g<C-x>", _7_, { desc = "Decrement", noremap = true }),
        },
        {
            keymap_20_auto.set("v", "<C-a>", _8_, { desc = "Increment", noremap = true }),
            keymap_20_auto.set("v", "<C-x>", _9_, { desc = "Decrement", noremap = true }),
            keymap_20_auto.set("v", "g<C-a>", _10_, { desc = "Increment", noremap = true }),
            keymap_20_auto.set("v", "g<C-x>", _11_, { desc = "Decrement", noremap = true }),
        },
    }
end
local _12_
...
do
    ...
    _23_ = {
        {
            keymap_20_auto.set({ "n", "x", "o" }, "s", _26_, { desc = "Jump", noremap = true }),
            keymap_20_auto.set({ "n", "x", "o" }, "S", _27_, { desc = "Jump treesitter", noremap = true }),
            keymap_20_auto.set({ "o" }, "r", _28_, { desc = "Flash remote", noremap = true }),
            keymap_20_auto.set({ "x", "o" }, "R", _29_, { desc = "Flash treesitter search", noremap = true }),
            keymap_20_auto.set({ "n", "x", "o" }, "f", _30_, { desc = "Flash find next", noremap = true }),
            keymap_20_auto.set({ "n", "x", "o" }, "F", _31_, { desc = "Flash find previous", noremap = true }),
            keymap_20_auto.set({ "n", "x", "o" }, "t", _32_, { desc = "Flash up to", noremap = true }),
            keymap_20_auto.set({ "n", "x", "o" }, "T", _33_, { desc = "Flash up to previous", noremap = true }),
        },
    }
end
local _34_
...
local function _38_(...)
    ...
    return {
        { keymap_20_auto.set("n", "<leader>u", "<cmd>UndotreeToggle<cr>", { desc = "Undo Tree", noremap = true }) },
    }
end
