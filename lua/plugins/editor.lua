...
do
    ...
    do
        ...
        keymap_30_auto = mod_13_auto.keymap({ "dial.nvim", for_cat = "general.extra", on_require = "dial" })
    end
    do
        local function _1_()
    ...
    do
        ...
        local function _9_()
            if vim.fn.executable("direnv") == 1 then
                ...
                return p_14_auto.setup({ async = true, on_direnv_finished = _10_, type = "buffer" })
            else
                return nil
            end
        end
        keymap_30_auto =
            mod_13_auto.keymap({ "direnv-nvim", after = _9_, event = "DeferredUIEnter", for_cat = "general.extra" })
    end
end
do
    local keymap_30_auto
    do
        ...
        keymap_30_auto =
            mod_13_auto.keymap({ "fidget.nvim", after = _13_, event = "DeferredUIEnter", for_cat = "general.extra" })
    end
end
do
    local keymap_30_auto
    do
        ...
        keymap_30_auto =
            mod_13_auto.keymap({ "foldtext-nvim", after = _14_, event = "DeferredUIEnter", for_cat = "general.extra" })
    end
end
do
    local keymap_30_auto
    do
        ...
        keymap_30_auto =
            mod_13_auto.keymap({ "flash.nvim", after = _15_, for_cat = "general.always", on_require = "flash" })
    end
    local function _17_()
...
do
    ...
    do
        ...
        keymap_30_auto =
            mod_13_auto.keymap({ "mini.ai", after = _25_, event = "CursorMoved", for_cat = "general.extra" })
    end
end
do
    local keymap_30_auto
    do
        ...
        keymap_30_auto =
            mod_13_auto.keymap({ "mini.indentscope", after = _28_, event = "CursorMoved", for_cat = "general.extra" })
    end
end
do
    local keymap_30_auto
    do
        ...
        keymap_30_auto =
            mod_13_auto.keymap({ "nvim-surround", after = _31_, event = "CursorMoved", for_cat = "general.always" })
    end
end
local keymap_30_auto
do
