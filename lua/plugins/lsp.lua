...
do
    ...
    do
        ...
        keymap_29_auto = mod_12_auto.keymap({ "symbol-usage.nvim", after = _4_, event = "LspAttach", for_cat = "lsp" })
    end
end
local keymap_29_auto
do
    ...
    keymap_29_auto = mod_12_auto.keymap({ "nvim-navic", after = _5_, for_cat = "lsp", on_require = "nvim-navic" })
end
