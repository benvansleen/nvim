...
(tb "telescope.nvim"
    {:for_cat "general.telescope"
     ...
     :keys [(tb ";"
            ...
            (tb "<leader>fh"
                (require-and-call :telescope.builtin "oldfiles")
                {:mode ["n"]
                 :desc "[F]ind in file [H]istory"})
            (tb "<leader>fb"
                (require-and-call :telescope.builtin "buffers")
                {:mode ["n"]
                 :desc "[F]ind [B]uffer"})
            (tb "<leader>fl"
                ...
                {:mode ["n"]
                 :desc "[F]ind [L]ine"})
            (tb "<leader>fd"
                (require-and-call :telescope.builtin "diagnostics")
                {:mode ["n"]
                 :desc "[F]ind [D]iagnostic"})
            (tb "<leader>fr"
                (require-and-call :telescope.builtin "resume")
                {:mode ["n"]
                 :desc "[F]ind [R]resume"})
            (tb "<leader>fk"
                (require-and-call :telescope.builtin "keymaps")
                {:mode ["n"]
                 :desc "[F]ind [K]eymap"})
            (tb "<leader>fH"
                (require-and-call :telescope.builtin "help_tags")
                {:mode ["n"]
                 :desc "[F]ind [H]elp"})
            (tb "<leader>fm"
                ...
                {:mode ["n"]
                 :desc "[F]ind [M]essage"})
            (tb "<leader>ft"
                (require-and-call :telescope.builtin "builtin")
                {:mode ["n"]
